...
//		earthquakesURL = "test2.atom";
	...
	private void addKey() {
		...
		text("Land 	Quake", 65, 135);
		text("Ocean Quake", 65, 166);
		text("Size ~ Magnitude", 40, 190);
		text("Shallow", 65, 220);
		text("Intermediate", 65, 245);
		text("Deep", 65, 270);
	}
	...
	private void printQuakes()
	{
		...
		System.out.println("Printing all Earthquake data: ");
		int oQCounter = 0;
		for (Marker cm : countryMarkers) {
			...
			if (eqCounter > 0) {
				System.out.println(countryName + " : " + eqCounter);
				eqCounter = 0;
			}
		}
		for (Marker m : quakeMarkers) {
		...
		System.out.println("Ocean Quakes : " + oQCounter);
